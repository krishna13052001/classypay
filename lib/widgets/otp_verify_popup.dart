...
import 'package:classypay/screens/home_screen.dart';
...
class OtpVerifyPopup extends StatelessWidget {
  ...
  OtpVerifyPopup({this.user, this.isLogin = false, required this.phoneNumber});
...
class ResendTimerWidget extends StatefulWidget {
  ...
  final String phoneNumber;
  ResendTimerWidget(
      {this.user, this.isLogin = false, required this.phoneNumber});
  @override
